...
export default class joinUsProgrammes18 extends Component {
  render() {
    return (
      <div className="row">
        ...
        <div className="col text2 mx-3">
          <div className="title4 orange headerHeight">
            COMBINE YOUR SPORTS CAREER WITH YOUR HIGHER EDUCATION
          </div>
          <div className="row d-flex p-3">
            <div className="programmesIconContainer">
              <img
            ...
            <div className="col">
              ...
              <div className="text3">
                UManresa professional development programme (in English)
              </div>
            </div>
          </div>
